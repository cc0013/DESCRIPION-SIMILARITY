...
from .PConvLayer import PConvLayer
from .VSRLayer import VSRLayer
...
class PRVSNet(BaseNetwork):
    ...
    # def forward(self, input, input_mask, input_edge): # 带遮罩的图片 遮罩 带遮罩的边缘
    def forward(self, input, input_mask):  # 带遮罩的图片 遮罩 带遮罩的边缘
